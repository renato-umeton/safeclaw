...
**Library acknowledgement policy:** Every third-party library added as a dependency must be acknowledged at the end of this list. See [CONTRIBUTING.md](CONTRIBUTING.md) for details.
